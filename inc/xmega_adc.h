...
public:
    XmegaAdc(ADC_t *adc, PORT_t *port_name, uint8_t pinAdc_bm, ADC_REFSEL_t ref, ADC_PRESCALER_t prescaler,ADC_CH_INPUTMODE_t signal,ADC_CH_MUXPOS_t pin_muxpos, ADC_CH_t *ch);
    XmegaAdc(ADC_t *adc, ADC_REFSEL_t ref, ADC_PRESCALER_t prescaler,ADC_CH_INPUTMODE_t signal,ADC_CH_MUXPOS_t pin_muxpos, ADC_CH_t *ch);
    void xmega_adc_init();
    ...
    uint16_t xmega_adc_read_result();
